...
if ( isset( $timeline_decades[ $timeline_decade ] ) ) {
	...
	<div class="decade-item">
		<div class="decade-image" style="background-image: url(<?php echo esc_url( $timeline_decades[ $timeline_decade ]['image'] ); ?>);"></div>
	...
	<div id="<?php echo $item_id; ?>" class="<?php echo implode( ' ', $column_classes ); ?>">
		...
		<div class="ti-inside-wrap">
			...
			<div class="ti-footer">
				<?php
				if ( $item_has_featured_image ) {
					echo '<figure class="t-featured-image"><img class="lazy" data-original="' . esc_url( spine_get_featured_image_src( 'spine-small_size' ) ) . '"></figure>';
				} else {
